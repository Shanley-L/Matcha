...
INSERT INTO users (username, email, password, firstname, gender, looking_for, bio, job, birthdate, country, city, suburb, interests, is_first_login, photos, match_type, is_connected, latest_connection) VALUES
    ...
    ('Medhi les zouzou', 'mehdi@example.com', 'hashed_password', 'Mehdi', 'male', 'female', 'Architecte et amateur de photographie urbaine.', 'Architecte', '1989-04-17', 'France', 'Paris', 'Montparnasse', '["architecture", "photography", "art"]', false, '["/init/mehdi.jpeg", "/init/mehdi.jpeg", "/init/mehdi.jpeg", "/init/mehdi.jpeg"]', 'business', true, NULL),
