...
INSERT INTO users (username, email, password, firstname, gender, looking_for, bio, job, birthdate, country, interests, is_first_login, photos, match_type) VALUES
    ...
    ('sarah', 'sarah@example.com', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN9V3UF9T3HJGQZsuHhJi', 'Sarah', 'female', 'male', 'Yoga instructor cherchant à partager bien-être et spiritualité.', 'Professeur de Yoga', '1991-03-12', 'United States', '["gym_fitness", "nature_plant", "people_society"]', false, '["/init/sarah.jpeg", "/init/sarah.jpeg", "/init/sarah.jpeg", "/init/sarah.jpeg"]', 'love'),
    ('charlotte', 'charlotte@example.com', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN9V3UF9T3HJGQZsuHhJi', 'Charlotte', 'female', 'male', 'Passionnée de littérature et de théâtre. J''aime les longues discussions autour d''un café.', 'Libraire', '1994-11-30', 'France', '["book_novel", "writing", "art"]', false, '["/init/charlotte.jpeg", "/init/charlotte.jpeg", "/init/charlotte.jpeg", "/init/charlotte.jpeg"]', 'friends'),
    ('francois', 'francois@example.com', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN9V3UF9T3HJGQZsuHhJi', 'Francois', 'male', 'female', 'Chef cuisinier, amateur de gastronomie et de vins. Je voyage pour découvrir de nouvelles saveurs.', 'Chef Cuisinier', '1988-07-19', 'France', '["food_drink", "travel_places", "photography"]', false, '["/init/francois.jpeg", "/init/francois.jpeg", "/init/francois.jpeg", "/init/francois.jpeg"]', 'love'),
    ...
    ('anissa', 'anissa@example.com', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN9V3UF9T3HJGQZsuHhJi', 'Anissa', 'female', 'male', 'Danseuse professionnelle. La musique est ma vie, la danse est ma passion.', 'Danseuse', '1992-09-08', 'Morocco', '["dancing_singing", "music", "fashion"]', false, '["/init/anissa.jpeg", "/init/anissa.jpeg", "/init/anissa.jpeg", "/init/anissa.jpeg"]', 'fling'),
    ('mehdi', 'mehdi@example.com', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN9V3UF9T3HJGQZsuHhJi', 'Mehdi', 'male', 'female', 'Architecte passionné par le design et l''art moderne. Amateur de photographie urbaine.', 'Architecte', '1989-04-17', 'France', '["architecture", "photography", "art"]', false, '["/init/mehdi.jpeg", "/init/mehdi.jpeg", "/init/mehdi.jpeg", "/init/mehdi.jpeg"]', 'business'),
    ...
    ('annie', 'annie@example.com', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN9V3UF9T3HJGQZsuHhJi', 'Annie', 'female', 'male', 'Professeure de langues, polyglotte. J''adore découvrir de nouvelles cultures et voyager.', 'Professeure', '1990-10-14', 'Canada', '["language", "travel_places", "people_society"]', false, '["/init/annie.jpeg", "/init/annie.jpeg", "/init/annie.jpeg", "/init/annie.jpeg"]', 'friends');
